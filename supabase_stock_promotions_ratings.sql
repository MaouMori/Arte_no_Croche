-- Ativa estoque, promocoes por desconto e avaliacoes de produtos.
-- Rode no SQL Editor do Supabase usado pelo Vercel.
...
-- Para produtos antigos sem estoque definido, deixe 1 unidade para aparecerem
-- no site ate voce ajustar os numeros reais pelo painel.
update public.products
